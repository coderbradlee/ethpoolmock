...
func (s *ProxyServer) fetchBlockTemplate() {
	...
	pendingReply.Difficulty = util.ToHex(s.config.Difficulty)
	log.Println("Header:",reply[0])
	log.Println("Seed:",reply[1])
	log.Println("Target:",reply[2])
	log.Println("Difficulty:",big.NewInt(diff))
